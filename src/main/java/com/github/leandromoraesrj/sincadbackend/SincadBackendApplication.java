...
//			regimeService.delete(regime1.getId());
			...
			logger.info(regimeService.listarTodos().toString());
			logger.info(regimeService.obter(1).toString());
			logger.info(regimeService.existe(1).toString());
			logger.info(regimeService.existe(0).toString());
			logger.info(regimeService.obterPorCodigo(1).toString());			
			logger.info(regimeService.consultarPorNome("simples").toString());
			logger.info(regimeService.consultarPorNomeOuCodigo("simples", 3).toString());
			logger.info(regimeService.consultarPorCodigos(Arrays.asList(1,2,3)).toString());
			logger.info(regimeService.consultarPorIds(Arrays.asList(1,2,3)).toString());

			logger.info(regimeService.consultarPorNomeOuCodigoVigente("Me",1).toString());

			logger.info(regimeService.consultarPorNomeVigente("Me").toString());
